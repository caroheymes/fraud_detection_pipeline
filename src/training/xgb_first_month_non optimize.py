...
def main():
    ...
    parser.add_argument(
        "--run-name",
        type=str,
        default=f"{model_name}_Run_{datetime.now().strftime('%H%M%S')}_first_month",
    ...
    # Si sample_size = -1, on prend tout le dataset, sinon un échantillon de cette taille
    ...
    # filter pour uniquement les 30 premiers jours
    ...
    with mlflow.start_run(run_name=args.run_name):
        ...
        # Enregistrement du modèle scikit-learn avec format pickle (contourne skops et supporte skrub)
